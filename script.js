...
class Transacao {
    static transferencia(contaOrigem, contaDestino, idTransacao, dataDeTransacao, valorDaTransferencia) {
        ...
        else {return "Saldo insuficiente para transferência!"}
    }
    ...
    static pagamentoSalario(contaOrigem, contaDestino, idPagamento, dataDoPagamento, valorDoSalario){
        if(valorDoSalario < 1000){
            ...
            else {"Saldo insuficiente para realizar o pagamento!"}
        }
        else {return "Seu limite máximo para este tipo de operação é de 1000, entre em contato com o banco!"}
    }
}
